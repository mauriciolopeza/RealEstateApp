...
CREATE TABLE `networks` (
  ...
  KEY `fk_networks_users_idx` (`fk_users_id`),
  KEY `fk_networks_companies_idx` (`fk_companies_id`),
  CONSTRAINT `fk_networks_companies` FOREIGN KEY (`fk_companies_id`) REFERENCES `companies` (`companies_id`),
  CONSTRAINT `fk_networks_users` FOREIGN KEY (`fk_users_id`) REFERENCES `users` (`users_id`)
...
-- Dump completed on 2019-05-29 22:27:43
