...
CREATE TABLE `notifications` (
  ...
  KEY `fk_notifications_users_idx` (`fk_users_id`),
  CONSTRAINT `fk_notifications_users` FOREIGN KEY (`fk_users_id`) REFERENCES `users` (`users_id`)
...
INSERT INTO `notifications` VALUES (1,2,'Call proffesor','2019-06-20 23:52:00');
