...
CREATE TABLE `tasks` (
  ...
  KEY `fk_tasks_users_idx` (`fk_users_id`),
  CONSTRAINT `fk_tasks_users` FOREIGN KEY (`fk_users_id`) REFERENCES `users` (`users_id`)
...
INSERT INTO `tasks` VALUES (1,'View Downtown Apartments','View all available Apts in Downtown Area',2,NULL,'2019-06-20 23:33:00');
...
-- Dump completed on 2019-06-09 10:39:26
